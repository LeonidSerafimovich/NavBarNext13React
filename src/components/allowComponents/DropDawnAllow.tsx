...
import AllowInfo from './allowInfo'
...
const DropDownAllow: React.FC<DropDownLicenseProps> = ({
	predefinedValues,
	defaultText,
	licenses
}) => {
	...
	return (
		<div className='w-72 font-medium relative' ref={menuRef}>
			...
			{menuOpen && (
				<ul className='bg-white mt-2 overflow-y-auto cursor-pointer absolute z-10'>
			...
			<AllowInfo licenses={licenses} selectedLicense={selectedValue} />
		</div>
	)
}

export default DropDownAllow
